...
class Profile(models.Model):
    ...
    id_tipo_user = models.ForeignKey("CRUDapp.Tipo_user", on_delete=models.CASCADE, null=True,)
...
class Inmuebles(models.Model):
    id_region = models.ForeignKey("CRUDapp.Region", on_delete=models.CASCADE, null=True,)
    id_comuna = models.ForeignKey("CRUDapp.Comuna", on_delete=models.CASCADE, null=True,)
    id_user = models.ForeignKey("auth.User", on_delete=models.CASCADE, null=True,)
    id_tipo_inmueble = models.ForeignKey("CRUDapp.Tipo_inmueble", on_delete=models.CASCADE, null=True,)
